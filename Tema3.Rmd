...
data2<-ggplot(datos_filtrados, aes(x = date, y = new_deaths_smoothed_per_million, color = location)) +
  geom_line(size = 0.1)+labs(title='Gráfico de nuevas muertes en millones', x= 'Años', y = 'nuevas muertes en millones') + geom_line(data = filter(datos_filtrados, location == "Spain"), size = 0.2, col = "black") + scale_x_date(limits=as.Date(c("2021-02-28","2022-02-28")))
data2
